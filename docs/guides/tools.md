...
| Tool                                              | Purpose                   | Platform             | Notes                                                                                                                           |
| ------------------------------------------------- | ------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [Figma](https://www.figma.com)                    | UI design and prototyping | Web, Desktop, Mobile | Design UI layouts and add interactions to produce a working UI prototype. [Free pro accounts](https://www.figma.com/education/) |
| [Excalidraw](https://excalidraw.com)              | Sketching / wire-framing  | Web                  | Simple hand-drawn style diagrams and wireframes. Great for quick mockups. Can export as PNG/SVG                                 |
| [tldraw](https://www.tldraw.com)                  | Sketching / wire-framing  | Web                  | Similar to Excalidraw but with a bit more polish. Good for quick UI sketches and diagrams                                       |
| [Realtime Colors](https://www.realtimecolors.com) | UI colour design          | Web                  | Select and test UI colour palettes. See colours applied to example UI elements                                                  |
...
| Tool                                                                  | Purpose                     | Platform | Notes                                                                  |
| --------------------------------------------------------------------- | --------------------------- | -------- | ---------------------------------------------------------------------- |
| Browser Dev. Tools                                                    | Inspect / debug HTML/CSS/JS | Browser  | Press <kbd>F12</kbd>, or <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>I</kbd> |
| [Responsively](https://responsively.app)                              | Responsive design testing   | Desktop  | Preview your web app on multiple screen sizes simultaneously           |
...
| Tool                                      | Purpose                | Platform | Notes                                                                                |
| ----------------------------------------- | ---------------------- | -------- | ------------------------------------------------------------------------------------ |
| [SQLite Studio](https://sqlitestudio.pl/) | Database management    | Desktop  | Manage and work with SQLite databases. Add / edit data, run test queries, etc.       |
...
| Tool                         | Purpose                 | Notes                                                                                     |
| ---------------------------- | ----------------------- | ----------------------------------------------------------------------------------------- |
| [Render](https://render.com) | Web hosting             | Generous free account (with limitations) to host Flask web apps. Auto-deploys from GitHub |
| [Turso](https://turso.tech)  | SQLite database hosting | Generous free tier for hosting SQLite databases                                           |
